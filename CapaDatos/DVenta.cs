...
namespace CapaDatos
{
    public class DVenta
    {
        ...
        public DVenta(int idventa, int idcliente, int idtrabajador, string fecha, string tipo_comprobante, string serie, string correlativo, decimal igv)
        {
        ...
        //Mostrar Artuculo por su nombre
