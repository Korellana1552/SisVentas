   ...
   public class DDetalle_Ingreso
    {
        ...
        private string _Fecha_Produccion;
        ...
        public DDetalle_Ingreso(int iddetalle_ingreso, int idingreso, int idarticulo, decimal precio_compra, decimal precio_venta, int stock_inicial, int stock_actual, string fecha_produccion, string fecha_vencimiento)
        {
