...
namespace CapaDatos
{
    public class DCliente
    {
        ...
        public DCliente(int idcliente, string nombre, string apellidos, string sexo, string fecha_nacimiento, string tipo_documento, string num_documento, string direccion, string telefono, string email, string textobuscar)
        {
