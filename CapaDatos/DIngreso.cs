...
namespace CapaDatos
{
    public class DIngreso
    {
        ...
        public DIngreso(int idingreso, int idtrabajador, int idproveedor, string fecha, string tipo_comprobante, string serie, string correlativo, decimal igv, string estado)
        {
