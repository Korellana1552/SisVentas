...
namespace CapaDatos
{
    public class DTrabajador
    {
        ...
        public DTrabajador(int idtrabajador, string nombre, string apellidos, string sexo, string fecha_nacimiento, string num_documento, string direccion, string telefono, string email, string acceso, string usuario, string password, string textobuscar)
        {
