...
namespace CapaNegocio
{
    public class NCliente
    {
        ...
        //de la CapaDatos
        public static string Insertar(string nombre, string apellidos, string sexo, string fecha_nacimiento, string tipo_documento, string num_documento, string direccion, string telefono, string email)
        {
        ...
        //de la CapaDatos
        public static string Editar(int idcliente, string nombre, string apellidos, string sexo, string fecha_nacimiento, string tipo_documento, string num_documento, string direccion, string telefono, string email)
        {
            DCliente Obj = new DCliente();
