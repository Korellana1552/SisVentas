...
namespace CapaNegocio
{
    public class NTrabajador
    {
        ...
        //de la CapaDatos
        public static string Insertar(string nombre, string apellidos, string sexo, string fecha_nacimiento,
        ...
        //de la CapaDatos
        public static string Editar(int idtrabajador, string nombre, string apellidos, string sexo, string fecha_nacimiento,
            string num_documento, string direccion, string telefono, string email,
            string acceso, string usuario, string password)
        {
            DTrabajador Obj = new DTrabajador();
