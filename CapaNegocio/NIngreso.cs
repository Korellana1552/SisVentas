...
namespace CapaNegocio
{
    public class NIngreso
    {
        ...
        //de la CapaDatos
        public static string Insertar(int idtrabajador, int idproveedor, string fecha, string tipo_comprobante, string serie, string correlativo, decimal igv, string estado, DataTable dtDetalles)
        {
            ...
            foreach (DataRow row in dtDetalles.Rows)
            {
                ...
                detalle.Fecha_Produccion = Convert.ToString(row["fecha_produccion"].ToString());
                detalle.Fecha_Vencimiento = Convert.ToString(row["fecha_vencimiento"].ToString());
