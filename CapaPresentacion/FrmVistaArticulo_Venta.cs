...
namespace CapaPresentacion
{
    public partial class FrmVistaArticulo_Venta : Form
    {
        ...
        private void dataListado_DoubleClick(object sender, EventArgs e)
        {
            ...
            par1 = Convert.ToString(this.dataListado.CurrentRow.Cells["iddetalle_Venta"].Value);
            ...
            par6 = Convert.ToString(this.dataListado.CurrentRow.Cells["fecha_vencimiento"].Value);
